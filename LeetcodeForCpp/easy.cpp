...
/// <summary>
/// 將羅馬數字拆成多個子字串，子字串符合"最左邊為最小字元，往右依序變大"的規則
/// </summary>
...
bool Easy::isValid(std::string s)
{
    ...
    // 第一組括弧間包含了其他括弧
        ...
        if (n_right == 0) {
            ...
            // 判斷 "首個找到的括弧中間區段" 以及 "右括弧以右的區段" 分別是否也合法
...
/// <summary>
/// 找到左括弧 -1，找到右括弧 +1，當找到合法的區段後就回傳索引值
/// 當先找到兩個左括弧，就必須找到兩個右括弧才算成功，以此類推。
/// </summary>
